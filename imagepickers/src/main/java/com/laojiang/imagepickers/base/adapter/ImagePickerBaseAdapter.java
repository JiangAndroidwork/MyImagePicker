package com.laojiang.imagepickers.base.adapter;
...
public abstract class ImagePickerBaseAdapter<T> extends BaseAdapter
{
    ...
    private com.laojiang.imagepickers.base.adapter.ImagePickerItemViewManager<T> mItemViewManager;
    ...
    public ImagePickerBaseAdapter(Context context, List<T> datas)
    {
        ...
        mItemViewManager = new com.laojiang.imagepickers.base.adapter.ImagePickerItemViewManager<>();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        com.laojiang.imagepickers.base.adapter.ImagePickerViewHolder holder = null;
        if (convertView == null)
        {
            convertView = LayoutInflater.from(mContext).inflate(layoutId, parent, false);
            holder = new com.laojiang.imagepickers.base.adapter.ImagePickerViewHolder(mContext, convertView, position, layoutId);
            onCreateConvertView(position, convertView, holder, parent);
            convertView.setTag(holder);
        } else
        {
            holder = (com.laojiang.imagepickers.base.adapter.ImagePickerViewHolder) convertView.getTag();
    ...
    protected void onCreateConvertView(int position, View convertView, com.laojiang.imagepickers.base.adapter.ImagePickerViewHolder holder, ViewGroup parent)
    {

    }

    protected void onReuseConvertView(int position, View convertView, com.laojiang.imagepickers.base.adapter.ImagePickerViewHolder holder, ViewGroup parent)
    {

    }

    protected void setData(com.laojiang.imagepickers.base.adapter.ImagePickerViewHolder viewHolder, T item, int position, ViewGroup parent)
    {
