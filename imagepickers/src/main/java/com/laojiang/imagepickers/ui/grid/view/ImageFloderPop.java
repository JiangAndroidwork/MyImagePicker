...
public class ImageFloderPop implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener
{
    ...
    private com.laojiang.imagepickers.ui.grid.adapter.ImageFloderAdapter mAdapter;
    ...
    public void showAtBottom(Activity activity, View parent, ImageFloderBean curFloder, onFloderItemClickListener listener)
    {
        ...
        mAdapter = new com.laojiang.imagepickers.ui.grid.adapter.ImageFloderAdapter(activity, position);
